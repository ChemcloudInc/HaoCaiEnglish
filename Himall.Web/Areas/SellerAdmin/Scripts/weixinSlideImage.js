...
function initVShopBannerTable() {
    ...
    $("#vshopBannerTable").hiMallDatagrid({
        ...
        [[
            ...
            {
                field: "url", title: '跳转地址', align: "left", width: 180, formatter: function (value, row, index) {
                    return '<span class="overflow-ellipsis" style="width:180px">' + value + '</span> ';
                },
            },
            {
        ...
        if (result.success) {
            $.dialog({
                ...
                button: [
                {
                    name: '确认',
                    callback: function () {
                        if ($("#txtBannerName1").val().length > 10) {
                        ...
                        AddVShopBanner(id, $("#txtBannerName1").val(), $("#bannerUrl").val(), $("#ddlType1").val());
                    },
                    focus: true
                },
                {
