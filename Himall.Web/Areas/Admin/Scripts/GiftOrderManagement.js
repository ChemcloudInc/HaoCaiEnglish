...
$(function () {
    $('.nav li[type="statusTab"]').click(function (e) {
        var _t = $(this);
        ...
        content: ['<div class="dialog-form">',
           ...
           ' </div>',
             '<div class="form-group">',
                ...
                '<p class="help-top"><input class="input-xs cssShipOrderNumber" id="intexpnum" name="intexpnum" type="text" value=""></p>',
           ' </div>',
        '</div>'].join(''),
        padding: '10px',
...
function vieworder(id) {
    ...
    if (ExpressCompanyName != "" & ShipOrderNumber != "") {
        ...
        var loading = showLoading();
        // 物流信息
        $.post('/Admin/Gift/GetExpressData', { expressCompanyName: data.ExpressCompanyName, shipOrderNumber: ShipOrderNumber }, function (result) {
            loading.close();
            var html = "";
