        ...
        if (cart.products.length == 0) {
            ...
            $.each(data, function (i, e) {
                if (e.shop[0].vshopId != 0) {
                    str += '<li class="list-group-item"><div class="cart-shop"><i class="glyphicon glyphicon-ok check-custom"></i><span><a href="/' + areaName + '/vshop/detail/' + e.shop[0].vshopId + '">'
                    if(e.shop[0].shopLogo==null)
                    {
                        str+='<img src="http://fpoimg.com/40x24" />';
                    }
                    else
                        str += '<img src="' + e.shop[0].shopLogo + '" height="24" />'
                    str+= e.name+'</a></span></div>';
                }
                else
                {
                    str += '<li class="list-group-item"><div class="cart-shop"><i class="glyphicon glyphicon-ok check-custom"></i><span>';
                    if (e.shop[0].shopLogo == null) {
                        str += '<img src="http://fpoimg.com/40x24" />'
                    }
                    else
                ...
                $.each(e.shop, function (j, product) {
                    if (product.status == 1) {
                        ...
                        <div class="cart-goods">\
                            <i class="glyphicon glyphicon-ok check-custom"></i>\
                            <a><img src="'+ product.imgUrl + '" /></a>\
                                <p><a href="/'+ areaName + '/product/detail/' + product.id + '">' + product.name + '</a></p><span id="price">¥' + product.price + '</span>\
                            <div class="wrap-num">\
