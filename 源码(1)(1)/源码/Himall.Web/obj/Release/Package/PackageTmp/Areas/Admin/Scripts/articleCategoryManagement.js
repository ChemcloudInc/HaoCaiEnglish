...
function edit(id, defaultParentId) {
    ...
    $.post('GetArticleCategories', { parentId: 0 }, function (data) {
        var selector = '<select id="parentArticleCategory" class="form-control input-sm"><option value="0" >无</option>';
        ...
        $.dialog({
            ...
            content: ['<div class="dialog-form">',
                '<div class="form-group">',
                    '<label class="label-inline" for="">名称</label><input class="form-control input-sm" maxlength="5" type="text" id="articleName" value="' + oriArticleCateogry.name + '">',
                    '<p class="help-block">不能多于5个字</p>',
                '</div>',
                '<div class="form-group">',
