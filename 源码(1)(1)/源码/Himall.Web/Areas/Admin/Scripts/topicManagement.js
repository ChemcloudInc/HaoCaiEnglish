...
$(function () {
    ...
    $("#topicGrid").hiMallDatagrid({
        ...
        [[
            {
                field: "name", title: '专题名称', width: 750, align: "left", formatter: function (value, row, index) {
                    var html = '<a href="/topic/detail/' + row.id + '" target="_blank">' + row.name + '</a>';
                    return html;
                }
            },
            {
                field: "IsRecommend", title: '是否推荐', width: 50, align: "center", formatter: function (value, row, index) {
