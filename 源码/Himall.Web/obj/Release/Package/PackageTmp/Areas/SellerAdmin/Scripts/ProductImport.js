...
function fnUploadFileCallBack(filename) {
    ...
    $.ajax({
        ...
        , data: { paraCategory: parseFloat($('#category3').val()), paraShopCategory: shopCategory, paraBrand: $('#selectBrand').val(), paraSaleStatus: paraSaleStatus, _shopid: $('#inputShopid').val(), _userid: $('#inputUserid').val(), file: filename }
        , datatype: 'json'
