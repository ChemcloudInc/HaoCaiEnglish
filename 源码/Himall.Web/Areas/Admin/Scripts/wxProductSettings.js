...
function initGrid() {
    ...
    $("#productList").hiMallDatagrid({
        ...
        [[
             {
                field: "name", title: '商品名称', width: 300, align: "left",
            ...
            {
                field: "price", title: '价格', align: "left", formatter: function (value, row, index) { return '$' + value; }
            },
            {
                field: "brand", title: '品牌', align: "left"
            },
            {
                field: "sequence", title: '排序', align: "left", formatter: function (value, row, index) {
                    return '<input class="text-order" type="text" orivalue="' + value + '" hpId="' + row.id + '" name="sequence" value="' + value + '">';
                }
            },
            {
                field: "categoryName", title: '三级分类', align: "left"
            },
            {
